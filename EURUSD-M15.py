...
# immport libraries and packages
...
class rates_historic(DWX_ZMQ_Strategy):
    ...
    def onPullData(self, data):       
        ...
        #for a in (d):
        #    print(a)
        dataset_train = df[:8000]
        dataset_test = df[8000:10000]
        series = dataset_train.iloc[:,2:3].values
        ...
        # step 3 - splitting in train and test
        X_train = series[0:6500]
        y_train = series[1:6501]
        X_test = series[6500:]

        X_train = X_train.reshape(6500,1,1)
        X_test = X_test.reshape(1500,1,1)
    ...
    def run(self):        
        ...
        self._zmq._DWX_MTX_SEND_MARKETHIST_REQUEST_(_symbol='EURUSD.r',
                                                    _timeframe=60,
                                                    _start='2020.01.10 00:00:00',
                                                    _end  ='2020.01.20 00:00:00')
